...
{
public class X12_00501_271
    {
        public Node Root = 
        new Node
        {
            Name = "X12_00501_271",  IsOptional = false,
            Nodes = new Node[]
            {
                new Node
                {
                ...
                new Node
                {
                    Name = "TS271_2000A_Loop",  IsOptional = false,
                    Nodes = new Node[]
                    {
                        new Node
                        {
                        ...
                        new Node
                        {
                            Name = "AAA_RequestValidation",  IsOptional = false,
                            Segment = new Segment
                            {
                        ...
                        new Node
                        {
                            Name = "TS271_2100A_Loop",  IsOptional = false,
                            Nodes = new Node[]
                            {
                                new Node
                                {
                                ...
                                new Node
                                {
                                    Name = "PER_InformationSourceContactInformation",  IsOptional = false,
                                    Segment = new Segment
                                    {
                                        Tag = "PER",  Min = 0,  Max = 3,  Name = "Information Source Contact Information",
                                        Elements = new[]
                                        {
                                ...
                                new Node
                                {
                                    Name = "AAA_RequestValidation_2",  IsOptional = false,
                                    Segment = new Segment
                                    {
                                        Tag = "AAA",  Min = 0,  Max = 9,  Name = "Request Validation",
                                        Elements = new[]
                        ...
                        new Node
                        {
                            Name = "TS271_2000B_Loop",  IsOptional = false,
                            Nodes = new Node[]
                            {
                                new Node
                                {
                                ...
                                new Node
                                {
                                    Name = "TS271_2100B_Loop",  IsOptional = false,
                                    Nodes = new Node[]
                                    {
                                        new Node
                                        {
                                        ...
                                        new Node
                                        {
                                            Name = "AAA_InformationReceiverRequestValidation",  IsOptional = false,
                                            Segment = new Segment
                                            {
                                                Tag = "AAA",  Min = 0,  Max = 9,  Name = "Information Receiver Request Validation",
                                                Elements = new[]
                                                {
                                                    new Element { Name = "Yes/No Condition or Response Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1073" },
                                                    new Element { Name = "Agency Qualifier Code", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_559" },
                                ...
                                new Node
                                {
                                    Name = "TS271_2000C_Loop",  IsOptional = false,
                                    Nodes = new Node[]
                                    {
                                        new Node
                                        {
                                        ...
                                        new Node
                                        {
                                            ...
                                            Segment = new Segment
                                            {
                                                Tag = "TRN",  Min = 0,  Max = 3,  Name = "Subscriber Trace Number",
                                                Elements = new[]
                                                {
                                        ...
                                        new Node
                                        {
                                            Name = "TS271_2100C_Loop",  IsOptional = false,
                                            Nodes = new Node[]
                                            {
                                                new Node
                                                {
                                                ...
                                                new Node
                                                {
                                                    Name = "AAA_SubscriberRequestValidation",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                ...
                                                new Node
                                                {
                                                    Name = "INS_SubscriberRelationship",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                ...
                                                new Node
                                                {
                                                    ...
                                                    Segment = new Segment
                                                    {
                                                        Tag = "DTP",  Min = 0,  Max = 9,  Name = "Subscriber Date",
                                                        Elements = new[]
                                                        {
                                                ...
                                                new Node
                                                {
                                                    Name = "MPI_SubscriberMilitaryPersonnelInformation",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                        Tag = "MPI",  Min = 0,  Max = 1,  Name = "Subscriber Military Personnel Information",
                                                        Elements = new[]
                                                        {
                                                            new Element { Name = "Information Status Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1201" },
                                                            ...
                                                            new Element { Name = "Government Service Affiliation Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1595" },
                                                            new Element { Name = "Description", IsOptional = true, LengthMin = 1, LengthMax = 80, Type = "string", Value = "null", CodeTable = "null" },
                                                            new Element { Name = "Military Service Rank Code", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1596" },
                                                            new Element { Name = "Date Time Period Format Qualifier", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1250" },
                                                            new Element { Name = "Date Time Period", IsOptional = true, LengthMin = 1, LengthMax = 35, Type = "string", Value = "null", CodeTable = "null" },
                                                        }
                                                    } // end of "MPI"
                                                ...
                                                new Node
                                                {
                                                    Name = "TS271_2110C_Loop",  IsOptional = false,
                                                    Nodes = new Node[]
                                                    {
                                                        new Node
                                                        {
                                                            Name = "EB_SubscriberEligibilityorBenefitInformation",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "EB",  Min = 1,  Max = 1,  Name = "Subscriber Eligibility or Benefit Information",
                                                                Elements = new[]
                                                                {
                                                                    new Element { Name = "Eligibility or Benefit Information Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1390" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "HSD_HealthCareServicesDelivery",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "HSD",  Min = 0,  Max = 9,  Name = "Health Care Services Delivery",
                                                                Elements = new[]
                                                                {
                                                                    new Element { Name = "Quantity Qualifier", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_673" },
                                                                    new Element { Name = "Quantity", IsOptional = true, LengthMin = 1, LengthMax = 15, Type = "decimal", Value = "null", CodeTable = "null" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "REF_SubscriberAdditionalIdentification_2",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "REF",  Min = 0,  Max = 9,  Name = "Subscriber Additional Identification",
                                                                Elements = new[]
                                                        ...
                                                        new Node
                                                        {
                                                            ...
                                                            Segment = new Segment
                                                            {
                                                                Tag = "DTP",  Min = 0,  Max = 20,  Name = "Subscriber Eligibility/Benefit Date",
                                                                Elements = new[]
                                                                {
                                                                    new Element { Name = "Date/Time Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_374" },
                                                                    new Element { Name = "Date Time Period Format Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1250" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "AAA_SubscriberRequestValidation_2",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "AAA",  Min = 0,  Max = 9,  Name = "Subscriber Request Validation",
                                                                Elements = new[]
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "MSG_MessageText",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "MSG",  Min = 0,  Max = 10,  Name = "Message Text",
                                                                Elements = new[]
                                                                {
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "TS271_2115C_Loop",  IsOptional = false,
                                                            Nodes = new Node[]
                                                            {
                                                                new Node
                                                                {
                                                                    Name = "III_SubscriberEligibilityorBenefitAdditionalInformation",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "III",  Min = 1,  Max = 1,  Name = "Subscriber Eligibility or Benefit Additional Information",
                                                                        Elements = new[]
                                                                        {
                                                                            new Element { Name = "Code List Qualifier Code", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1270" },
                                                                            new Element { Name = "Industry Code", IsOptional = true, LengthMin = 1, LengthMax = 30, Type = "string", Value = "null", CodeTable = "null" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "TS271_LS_Loop",  IsOptional = false,
                                                            Nodes = new Node[]
                                                            {
                                                                new Node
                                                                {
                                                                    Name = "LS_Header",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "LS",  Min = 1,  Max = 1,  Name = "Header",
                                                                        Elements = new[]
                                                                        {
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "TS271_2120C_Loop",  IsOptional = false,
                                                                    Nodes = new Node[]
                                                                    {
                                                                        new Node
                                                                        {
                                                                            Name = "NM1_SubscriberBenefitRelatedEntityName",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "NM1",  Min = 1,  Max = 1,  Name = "Subscriber Benefit Related Entity Name",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "Entity Identifier Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_98" },
                                                                                    new Element { Name = "Entity Type Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1065" },
                                                                        ...
                                                                        new Node
                                                                        {
                                                                            Name = "N3_SubscriberBenefitRelatedEntityAddress",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "N3",  Min = 0,  Max = 1,  Name = "Subscriber Benefit Related Entity Address",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "Address Information", IsOptional = false, LengthMin = 1, LengthMax = 55, Type = "string", Value = "null", CodeTable = "null" },
                                                                                    new Element { Name = "Address Information", IsOptional = true, LengthMin = 1, LengthMax = 55, Type = "string", Value = "null", CodeTable = "null" },
                                                                        ...
                                                                        new Node
                                                                        {
                                                                            Name = "N4_SubscriberBenefitRelatedEntityCity_State_ZIPCode",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "N4",  Min = 0,  Max = 1,  Name = "Subscriber Benefit Related Entity City, State, ZIP Code",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "City Name", IsOptional = false, LengthMin = 2, LengthMax = 30, Type = "string", Value = "null", CodeTable = "null" },
                                                                                    new Element { Name = "State or Province Code", IsOptional = true, LengthMin = 2, LengthMax = 2, Type = "code", Value = "null", CodeTable = "Table_10156" },
                                                                        ...
                                                                        new Node
                                                                        {
                                                                            Name = "PER_SubscriberBenefitRelatedEntityContactInformation",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "PER",  Min = 0,  Max = 3,  Name = "Subscriber Benefit Related Entity Contact Information",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "Contact Function Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_366" },
                                                                                    new Element { Name = "Name", IsOptional = true, LengthMin = 1, LengthMax = 60, Type = "string", Value = "null", CodeTable = "null" },
                                                                        ...
                                                                        new Node
                                                                        {
                                                                            Name = "PRV_SubscriberBenefitRelatedProviderInformation",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "PRV",  Min = 0,  Max = 1,  Name = "Subscriber Benefit Related Provider Information",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "Provider Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1221" },
                                                                                    new Element { Name = "Reference Identification Qualifier", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_128" },
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "LE_Trailer",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "LE",  Min = 1,  Max = 1,  Name = "Trailer",
                                                                        Elements = new[]
                                                                        {
                                                                            new Element { Name = "Loop Identifier Code", IsOptional = false, LengthMin = 1, LengthMax = 4, Type = "string", Value = "null", CodeTable = "null" },
                                                                        }
                                        ...
                                        new Node
                                        {
                                            Name = "TS271_2000D_Loop",  IsOptional = false,
                                            Nodes = new Node[]
                                            {
                                                new Node
                                                {
                                                ...
                                                new Node
                                                {
                                                    ...
                                                    Segment = new Segment
                                                    {
                                                        Tag = "TRN",  Min = 0,  Max = 3,  Name = "Dependent Trace Number",
                                                        Elements = new[]
                                                        {
                                                            new Element { Name = "Trace Type Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_481" },
                                                            new Element { Name = "Reference Identification", IsOptional = false, LengthMin = 1, LengthMax = 50, Type = "string", Value = "null", CodeTable = "null" },
                                                ...
                                                new Node
                                                {
                                                    Name = "TS271_2100D_Loop",  IsOptional = false,
                                                    Nodes = new Node[]
                                                    {
                                                        new Node
                                                        {
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "AAA_DependentRequestValidation",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                        ...
                                                        new Node
                                                        {
                                                            ...
                                                            Segment = new Segment
                                                            {
                                                                Tag = "DTP",  Min = 0,  Max = 9,  Name = "Dependent Date",
                                                                Elements = new[]
                                                                {
                                                                    new Element { Name = "Date/Time Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_374" },
                                                                    new Element { Name = "Date Time Period Format Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1250" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "MPI_DependentMilitaryPersonnelInformation",  IsOptional = false,
                                                            Segment = new Segment
                                                            {
                                                                Tag = "MPI",  Min = 0,  Max = 1,  Name = "Dependent Military Personnel Information",
                                                                Elements = new[]
                                                                {
                                                                    new Element { Name = "Information Status Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1201" },
                                                                    new Element { Name = "Employment Status Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_584" },
                                                        ...
                                                        new Node
                                                        {
                                                            Name = "TS271_2110D_Loop",  IsOptional = false,
                                                            Nodes = new Node[]
                                                            {
                                                                new Node
                                                                {
                                                                    Name = "EB_DependentEligibilityorBenefitInformation",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "EB",  Min = 1,  Max = 1,  Name = "Dependent Eligibility or Benefit Information",
                                                                        Elements = new[]
                                                                        {
                                                                            new Element { Name = "Eligibility or Benefit Information Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1390" },
                                                                            new Element { Name = "Coverage Level Code", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1207" },
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "HSD_HealthCareServicesDelivery_2",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "HSD",  Min = 0,  Max = 9,  Name = "Health Care Services Delivery",
                                                                        Elements = new[]
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "REF_DependentAdditionalIdentification_2",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "REF",  Min = 0,  Max = 9,  Name = "Dependent Additional Identification",
                                                                        Elements = new[]
                                                                ...
                                                                new Node
                                                                {
                                                                    ...
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "DTP",  Min = 0,  Max = 20,  Name = "Dependent Eligibility/Benefit Date",
                                                                        Elements = new[]
                                                                        {
                                                                            new Element { Name = "Date/Time Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_374" },
                                                                            new Element { Name = "Date Time Period Format Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1250" },
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "AAA_DependentRequestValidation_2",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "AAA",  Min = 0,  Max = 9,  Name = "Dependent Request Validation",
                                                                        Elements = new[]
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "MSG_MessageText_2",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "MSG",  Min = 0,  Max = 10,  Name = "Message Text",
                                                                        Elements = new[]
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "TS271_2115D_Loop",  IsOptional = false,
                                                                    Nodes = new Node[]
                                                                    {
                                                                        new Node
                                                                        {
                                                                            Name = "III_DependentEligibilityorBenefitAdditionalInformation",  IsOptional = false,
                                                                            Segment = new Segment
                                                                            {
                                                                                Tag = "III",  Min = 1,  Max = 1,  Name = "Dependent Eligibility or Benefit Additional Information",
                                                                                Elements = new[]
                                                                                {
                                                                                    new Element { Name = "Code List Qualifier Code", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1270" },
                                                                                    new Element { Name = "Industry Code", IsOptional = true, LengthMin = 1, LengthMax = 30, Type = "string", Value = "null", CodeTable = "null" },
                                                                ...
                                                                new Node
                                                                {
                                                                    Name = "TS271_LS_Loop1",  IsOptional = false,
                                                                    Segment = new Segment
                                                                    {
                                                                        Tag = "",  Min = 0,  Max = 1,  Name = "Loop for Loop Header",
                                                                        Elements = new[]
                                                                        {
                                                                            new Element { Name = "", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "string", Value = "null", CodeTable = "null" },
                                                                            new Element { Name = "", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "string", Value = "null", CodeTable = "null" },
