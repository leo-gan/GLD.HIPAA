...
{
public class X12_00501_837_D
    {
        public Node Root = 
        new Node
        {
            Name = "X12_00501_837_D",  IsOptional = false,
            Nodes = new Node[]
            {
                new Node
                {
                                    ...
                                    Nodes = new Node[]
                                    {
                                        ...
                                        new Node
                                        {
                                            ...
                                            Nodes = new Node[]
                                            {
                                                ...
                                                new Node
                                                {
                                                    Name = "DTP_Date_AppliancePlacement",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                        Tag = "DTP",  Min = 0,  Max = 1,  Name = "Date - Appliance Placement",
                                                        Elements = new[]
                                                        {
                                                            new Element { Name = "Date/Time Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_374" },
                                                            new Element { Name = "Date Time Period Format Qualifier", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1250" },
                                        ...
                                        new Node
                                        {
                                            Name = "DN1_OrthodonticTotalMonthsofTreatment",  IsOptional = false,
                                            Segment = new Segment
                                            {
                                                Tag = "DN1",  Min = 0,  Max = 1,  Name = "Orthodontic Total Months of Treatment",
                                                Elements = new[]
                                                {
                                        ...
                                        new Node
                                        {
                                            Name = "DN2_ToothStatus",  IsOptional = false,
                                            Segment = new Segment
                                            {
                                                Tag = "DN2",  Min = 0,  Max = 35,  Name = "Tooth Status",
                                                Elements = new[]
                                                {
                                                    new Element { Name = "Reference Identification", IsOptional = false, LengthMin = 1, LengthMax = 50, Type = "string", Value = "null", CodeTable = "null" },
                                                    new Element { Name = "Tooth Status Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_1368" },
                                                    new Element { Name = "Quantity", IsOptional = true, LengthMin = 1, LengthMax = 15, Type = "decimal", Value = "null", CodeTable = "null" },
                                        ...
                                        new Node
                                        {
                                            ...
                                            Segment = new Segment
                                            {
                                                Tag = "NTE",  Min = 0,  Max = 5,  Name = "Claim Note",
                                                Elements = new[]
                                                {
                                        ...
                                        new Node
                                        {
                                            ...
                                            Segment = new Segment
                                            {
                                                Tag = "HI",  Min = 0,  Max = 1,  Name = "Health Care Diagnosis Code",
                                                Elements = new[]
                                                {
                                                    new Element { Name = "", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "string", Value = "null", CodeTable = "null" },
                                                    new Element { Name = "", IsOptional = true, LengthMin = 0, LengthMax = 0, Type = "string", Value = "null", CodeTable = "null" },
                                        ...
                                        new Node
                                        {
                                            ...
                                            Nodes = new Node[]
                                            {
                                                new Node
                                                {
                                                    Name = "LX_ServiceLineCounter",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                        Tag = "LX",  Min = 1,  Max = 1,  Name = "Service Line Counter",
                                                        Elements = new[]
                                                        {
                                                ...
                                                new Node
                                                {
                                                    Name = "SV3_DentalService",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                        Tag = "SV3",  Min = 1,  Max = 1,  Name = "Dental Service",
                                                        Elements = new[]
                                                        {
                                                            new Element { Name = "", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "string", Value = "null", CodeTable = "null" },
                                                            new Element { Name = "Monetary Amount", IsOptional = false, LengthMin = 1, LengthMax = 18, Type = "decimal", Value = "null", CodeTable = "null" },
                                                ...
                                                new Node
                                                {
                                                    Name = "TOO_ToothInformation",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                ...
                                                new Node
                                                {
                                                    Name = "AMT_SalesTaxAmount",  IsOptional = false,
                                                    Segment = new Segment
                                                    {
                                                        Tag = "AMT",  Min = 0,  Max = 1,  Name = "Sales Tax Amount",
                                                        Elements = new[]
                                                        {
                                                            new Element { Name = "Amount Qualifier Code", IsOptional = false, LengthMin = 0, LengthMax = 0, Type = "code", Value = "null", CodeTable = "Table_522" },
                                                            new Element { Name = "Monetary Amount", IsOptional = false, LengthMin = 1, LengthMax = 18, Type = "decimal", Value = "null", CodeTable = "null" },
